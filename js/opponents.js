const OPPONENT_DATA = [
  // === CIRCUITO DEL PUEBLO ===
  {
    ...
    quotes: [
      'DEJEME CANTAR ALMA DE ACERO\nY DESPUES LE PARTO EL ALMA\nA USTED TAMBIEN, MAE!',
      'ESTA CANCION SE LLAMA\nPICHAZO EN DO MAYOR\nY VA DEDICADA A USTED!',
      'EL MICROFONO ES MI ARMA\nLA MUSICA ES MI ESCUDO\nY SU CARA ES MI ESCENARIO!',
      'HOY CANTO BOLEROS\nPERO TAMBIEN CANTO\nEL REQUIEM DE SU DIGNIDAD!',
      'EN KARAOKE SOY REY\nEN EL RING SOY LEYENDA\nY USTED ES MI PUBLICO!',
    ],
    ...
    taunts: ['YO CANTO Y PEGO, MAE!', 'ESTA VA CON DEDICATORIA!', 'COMO DICE LA CANCION: LE DOY!', 'APLAUSO, APLAUSO!', 'MAS FUERTE QUE NOTA DE BAJO!', 'AFINE BIEN PORQUE VOY!', 'YO SOY EL ARTISTA AQUI!', 'LE CANTO EN EL OIDO, MAE!', 'EL KARAOKE NO PERDONA!', 'ESTA VA EN DO DE PECHO!', 'ME APLAUDEN HASTA LOS PUNOS!', 'USTED NO TIENE NI RITMO!'],
  ...
  },
  {
    ...
    quotes: [
      'BRO I JUST WANTED A CERVEZA...\nWHY IS EVERYONE FIGHTING?!\nTHIS WASNT ON TRIPADVISOR!',
      'DUDE MY TRAVEL INSURANCE\nDOESNT COVER FIST FIGHTS\nIN CENTRAL AMERICA BRO!',
      'MY SPANISH TEACHER NEVER\nTAUGHT ME THE WORD FOR\nGETTING PUNCHED IN THE FACE!',
      'BRO I WAS JUST TRYING TO\nFIND THE BEST GALLO PINTO\nNOT A BOXING MATCH!',
      'WAIT CAN I AT LEAST\nPOST THIS ON TIKTOK FIRST?\nMY FOLLOWERS NEED THIS!',
    ],
  ...
  },
  {
    ...
    quotes: [
      'AY NO, QUE ASCO TOTAL!\nME VA A ARRUINAR LAS UNAS!\nSABE CUANTO ME COSTARON?!',
      'OSEA LITERAL NO PUEDO\nCON GENTE TAN CORRIENTE\nES QUE ME DA CRINGE!',
      'DADDY ME DIJO QUE NADIE\nME TOCA NI UN PELO\nY YO LE HAGO CASO!',
      'MIS UNAS SON ARMAS LETALES\nMI CARTERA ES MI ESCUDO\nY MI ACTITUD ES MORTAL!',
      'AY POR DIOS QUE HORROR\nNI SIQUIERA TIENE MARCA\nQUE PENA AJENA TOTAL!',
    ],
  ...
  // === CIRCUITO DE LA FERIA ===
  {
    ...
    quotes: [
      'AQUI NO HAY REGLAS, HIJUEPUTA.\nLA CALLE ES LA CALLE.\nY YO SOY EL REY DE ESTA CALLE!',
      'EN LA CALLE SE APRENDE\nA PUNTA DE VERGASOS\nY YO SOY EL PROFESOR!',
      'NO OCUPO GUANTES NI RING\nYO PICHASEO EN LA ACERA\nCOMO DIOS MANDA!',
      'AQUI EL QUE NO CORRE VUELA\nY EL QUE NO VUELA\nLE PARTO LA JETA, MAE!',
      'ME CRIE SIN NADA\nPERO TENGO PUNOS DE SOBRA\nY HOY LOS REGALO TODOS!',
    ],
  ...
  },
  {
    ...
    quotes: [
      'MAE USTED SABE QUIEN ES MI TATA?\nLO VOY A DEMANDAR!\nMI CARRO VALE MAS QUE SU CASA!',
      'USTED NI PA VALETPARKING\nSIRVE EN MI CLUB\nQUE PENA ME DA!',
      'MI RELOJ VALE MAS\nQUE TODO SU BARRIO JUNTO\nPLEBEYO ASQUEROSO!',
      'VOY A LLAMAR A MI TATA\nPARA QUE LO DEMANDE\nY DESPUES LO PICHASEO YO!',
      'EN EL COUNTRY NO DEJAMOS\nENTRAR A GENTUZA COMO USTED\nPERO HOY HAGO EXCEPCION!',
    ],
  ...
  },
  {
    ...
    quotes: [
      'EL PATRIARCADO SE DESTRUYE\nA PICHAZOS TAMBIEN, HERMANE!\nEL MACHISMO ACABA HOY!',
      'MIS PUNOS SON FEMINISTAS\nMIS PATADAS SON INCLUSIVAS\nY SU CARA ES OPRESORA!',
      'LA REVOLUCION NO SE PIDE\nSE TOMA A PICHAZOS\nY HOY TOCA CLASE GRATIS!',
      'VENGO DEL CIRCO Y LA CALLE\nCON ARTE Y CON FURIA\nPREPARESE HERMANE!',
      'CADA GOLPE MIO\nES UN MANIFIESTO\nCONTRA LA OPRESION!',
    ],
  ...
  // === CIRCUITO DEL REDONDEL ===
  {
    ...
    quotes: [
      'VENGA, VENGA, QUE YO LE PARTO\nLA CARA GRATIS, PAPISONGO!\nYO NO COBRO POR PICHASEAR!',
      'QUIERO HABLAR CON SU GERENTE\nAH NO TIENE? ENTONCES\nYO SOY LA GERENTA DE SUS PICHAZOS!',
      'VOY A DEJAR UNA RESENA\nDE UNA ESTRELLA EN SU CARA\nSERVICIO PESIMO!',
      'ESTO ES INACEPTABLE\nINADMISIBLE E INDIGNANTE\nY USTED VA A PAGAR!',
      'MI ESPOSO ES ABOGADO\nMI CUNADO ES JUEZ\nY YO SOY SU PEOR PESADILLA!',
    ],
  ...
  },
  {
    ...
    quotes: [
      'EN EL TOPE DE PALMARES\nYO TUMBE A TRES DE UN LAZO!\nY TODAVIA TENIA BIRRA EN MANO!',
      'DE ZAPOTE A PALMARES\nNO HAY TOPE QUE ME PARE\nNI GUARO QUE ME TUMBE!',
      'LA ESPUELA ES MI ARMA\nEL LAZO ES MI ESCUDO\nY LA BIRRA ES MI GASOLINA!',
      'YIJAAA! JINETEANDO BOLOS\nDESDE EL NOVENTA Y OCHO\nY TODAVIA FIRME!',
      'EN EL REDONDEL O EN EL RING\nDA IGUAL, COMPA\nEL SABANERO SIEMPRE GANA!',
    ],
  ...
  },
  {
    ...
    quotes: [
      ...
      'EL UNIVERSO ME DIJO\nQUE HOY LE TOCA CAER\nY EL UNIVERSO NO MIENTE!',
      'MIS PUNOS VAN A 140 BPM\nSU CARA NO AGUANTA\nNI EL PRIMER DROP!',
      'LA PISTA DE BAILE\nES MI RING DE PELEA\nY HOY DJ PERSEFONE PONE DURISIMO!',
      'VIBRAS ALTAS PARA MI\nVIBRAS BAJAS PARA USTED\nASI FUNCIONA EL COSMOS!',
    ],
    health: 85, damage: { jab: 14, power: 22, special: 30 },
  ...
  // === CIRCUITO DE LA MUERTE ===
  {
    ...
    quotes: [
      ...
      'BIENVENIDO AL MOSH PIT\nAQUI NO HAY SALIDA\nSOLO BLAST BEATS Y PICHAZOS!',
      'SLAYER ME ENSENO A PELEAR\nPANTERA ME DIO LA FUERZA\nY USTED VA A SENTIR AMBAS!',
      'EL HEAVY METAL NO ES RUIDO\nES LA BANDA SONORA\nDE SU DESTRUCCION!',
      'HEADBANG HASTA LA MUERTE\nY HOY LA MUERTE\nTIENE SU NOMBRE, MAE!',
    ],
  ...
  },
  {
    ...
    quotes: [
      'BREDDA, I&I NO BUSCA WAR...\nPERO SI VIENE, JAH ME PROTEGE.\nDE LIMON CON AMOR Y PICHAZOS!',
      'FROM CAHUITA TO THE RING\nJAH GUIDE I EVERY STEP\nAND EVERY PUNCH, SEEN?',
      'BABYLON SEND YOU HERE\nBUT ZION PROTECT I\nYOU CANNOT WIN, BREDDA!',
      'ROOTS AND CULTURE IN MY FIST\nONE LOVE IN MY HEART\nBUT WAR PON YOUR FACE!',
      'DE LIMON CON FLOW\nCON RITMO Y CON FUERZA\nRASTA NO BUSINESS, BREDDA!',
    ],
  ...
  },
  {
    ...
    quotes: [
      'ESTA TIERRA ES DE MIS ANCESTROS.\nY USTED NO TIENE PERMISO.\nPREPARESE PARA EL JUICIO!',
      'MIL ANOS DE GUERRA\nCORREN POR MIS VENAS.\nHOY USTED LOS SIENTE!',
      'EL JAGUAR ACECHA.\nEL TRUENO RETUMBA.\nEL GUERRERO CASTIGA!',
      'SIBU ME DIO LA FUERZA.\nLA SELVA ME DIO LA ASTUCIA.\nY USTED NO TIENE NADA!',
      'LOS ESPIRITUS ANCESTRALES\nOBSERVAN ESTE COMBATE.\nNO LOS DECEPCIONE MURIENDO RAPIDO!',
    ],
...
class OpponentAI {
  ...
  update(playerState, tick) {
    ...
    this.animTimer++;
    if (this.animTimer >= 16) { this.animTimer = 0; this.animFrame = (this.animFrame + 1) % 2; }
  ...
  getAnimState() {
    switch (this.state) {
      ...
      case 'ko': return 'ko'; case 'taunt': return 'taunt'; case 'victory': return 'victory'; default: return 'idle';
    }
  }
